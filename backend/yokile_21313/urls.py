"""yokile_21313 URL Configuration
...
admin.site.site_header = "Yokile"
admin.site.site_title = "Yokile Admin Portal"
admin.site.index_title = "Yokile Admin"

# swagger
api_info = openapi.Info(
    title="Yokile API",
    default_version="v1",
    description="API documentation for Yokile App",
)
